        ...
        <div className="flex-1 min-w-0">
          {isEditing ? (
            <input
              ...
              placeholder="Title"
              autoFocus
              className="w-full text-2xl font-bold mb-2 bg-gray-800 border border-gray-700 focus:border-green-500 rounded px-2 py-1 outline-none"
            />
          ) : (
            <div className="flex items-start justify-between gap-3 mb-2">
              ...
              <button
                ...
                className="text-xs text-gray-400 hover:text-white bg-gray-800 hover:bg-gray-700 px-3 py-1.5 rounded flex-shrink-0"
              >
                ✏️ Edit
              </button>
            </div>
          ...
          {isEditing ? (
            <div className="bg-gray-900 rounded-lg overflow-hidden mb-4 border border-gray-700">
                ...
                {descTab === 'write' ? (
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: renderMarkdown(editDescription) || '<span class="text-gray-500">Nothing to preview</span>',
                    }}
                  />
                )}
              </div>
              ...
              <div className="px-3 pb-3 flex flex-wrap items-center gap-2">
                <span className="text-xs text-gray-500 uppercase font-semibold mr-1">Type</span>
                <select
                  value={editType}
              ...
              <div className="px-3 pb-3">
                <span className="text-xs text-gray-500 uppercase font-semibold block mb-2">Labels</span>
                <div className="flex flex-wrap gap-1">
                  {LABEL_OPTIONS.map((l) => (
                    <button
                      type="button"
                      key={l.name}
                      onClick={() => toggleEditLabel(l.name)}
                      className={`text-xs px-2 py-1 rounded-full border ${
                        editLabels.includes(l.name)
