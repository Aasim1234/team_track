...
export const AUDIT_ACTIONS = {
  ...
  comment_edited: { label: 'Edited comment' },
  ...
  section_assigned: { label: 'Assigned section' },
  task_completed: { label: 'Completed task' },
  bulk_task_completed: { label: 'Completed tasks in bulk' },
  bulk_task_closed: { label: 'Closed tasks in bulk' },
  bulk_task_reopened: { label: 'Reopened tasks in bulk' },
  ...
  release_status_changed: { label: 'Changed release status' },
  plan_status_changed: { label: 'Changed test plan status' },
  release_report_saved: { label: 'Saved release report' },
  release_report_removed: { label: 'Removed release report' },
  ...
  role_deleted: { label: 'Deleted role' },
  permission_granted: { label: 'Granted permission' },
  permission_revoked: { label: 'Revoked permission' },
  group_created: { label: 'Created group' },
  group_updated: { label: 'Edited group' },
  group_deleted: { label: 'Deleted group' },
  group_member_added: { label: 'Added to group' },
  group_member_removed: { label: 'Removed from group' },
